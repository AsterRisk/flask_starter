...
class PropertyForm(FlaskForm):
    ...
    desc      = StringField(id = "desc", widget = TextArea(), validators= [DataRequired()], render_kw = {"placeholder":"A short description of your property..."}, label = "Description")
    media     = FileField(id = "image", validators=[], label = "Photo")
    email     = StringField(id = "email", validators=[Email()], render_kw={"placeholder":"Email..."})
